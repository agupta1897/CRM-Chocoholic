...
public class ProviderRole {
    public static void providerTerminal() {
        ...
        String status = verifyMember(memberID);
        System.out.println("temp: enter status (1,2,3)");
        ...
        System.out.println("Enter date the service was provided\n" + "Format must be MM-DD-YYYY");
        
        //deal with how the date is stored
        ...
        String comment;
        Scanner scanLine = new Scanner(System.in).useDelimiter("\\n");
        if ("Yes".equals(ans))
